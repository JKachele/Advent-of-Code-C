...
int main(int argc, char *argv[]) {
        ...
        if (argc > 1 && strcmp(argv[1], "TEST") == 0) {
                ll = getInputFile("assets/tests/2023/Day08.txt");
        } else {
                ll = getInputFile("assets/inputs/2023/Day08.txt");
        }
        ...
        double pt1tTime = ((double)(pt1t - pt1) / CLOCKS_PER_SEC) * 1000;
        double pt2Time = ((double)(pt2 - pt1t) / CLOCKS_PER_SEC) * 1000;
        printf("Execution Time (ms) - Input Parse: %f, Part1 Hashing: %f, \
                        Part1 Linear: %f, Part2: %f\n", 
                        parseTime, pt1Time, pt1tTime, pt2Time);
